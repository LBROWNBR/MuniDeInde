...
$RutaFotoPersonal = '../images/personal/'.$pControlNomFoto;
...
<head>
    ...
    <!-- Title -->
    <title>Admin - Rym Portatiles</title>
                ...
                <ul class="side-menu app-sidebar3">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="/administrador/AdminControl">
                            ...
                            <span class="side-menu__label">Dashboard</span><span
                                class="badge badge-danger side-badge">New</span>
                        </a>
                    </li>
                        ...
                        <ul class="slide-menu ">
                            <li class="sub-slide">
                                <a class="sub-side-menu__item" data-toggle="sub-slide" href="#"><span
                                        class="sub-side-menu__label">Chat</span><i
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="#">
                            ...
                            <span class="side-menu__label">Forms</span><span
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="#">
                            ...
                            <span class="side-menu__label">Charts</span><span
                                class="badge badge-info side-badge">7</span></a>
                        <ul class="slide-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="#">
                            ...
                            <span class="side-menu__label">Icons</span><span
                                class="badge badge-warning side-badge">11</span></a>
                        <ul class="slide-menu">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li class="sub-slide">
                                <a class="sub-side-menu__item" data-toggle="sub-slide" href="#" onclick="">
                                    <span class="sub-side-menu__label">Mi Perfíl</span><i
                            ...
                            <li class="sub-slide">
                                <a class="sub-side-menu__item" data-toggle="sub-slide" href="#"><span
                                        class="sub-side-menu__label">Email</span><i
                                        class="sub-angle fe fe-chevron-down"></i></a>
                                <ul class="sub-slide-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="#">
                            ...
                            <span class="side-menu__label">E-Commerce</span><span
                                class="badge badge-secondary side-badge">3</span></a>
                        <ul class="slide-menu">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li class="sub-slide">
                                <a class="sub-side-menu__item" data-toggle="sub-slide" href="#"><span
                                        class="sub-side-menu__label">Login</span><i
                                        class="sub-angle fe fe-chevron-down"></i></a>
                                <ul class="sub-slide-menu">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                ...
                                                                data-image-src="../activos/pWebPageAdmin/assets/images/users/1.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="../activos/pWebPageAdmin/assets/images/users/2.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="../activos/pWebPageAdmin/assets/images/users/3.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="../activos/pWebPageAdmin/assets/images/users/4.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="../activos/pWebPageAdmin/assets/images/users/6.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="../activos/pWebPageAdmin/assets/images/users/7.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                    ...
                                    <div class="dropdown profile-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                                            ...
                                            <a class="dropdown-item d-flex" href="#">
                                                ...
                                                <div class="">Cambiar Contraseña</div>
                                            </a>
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © 2020 <a href="#">Administrador</a>. Diseñado por <a href="#">Charly Brown</a> Todos
