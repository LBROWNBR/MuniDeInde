    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9">
                ...
                @php
                $arrayProducto = $wData['DataproductoGeneral'];

                if($arrayProducto) foreach ($arrayProducto as $DataProducto):

                    $codproduct = $DataProducto->cod_product;
                    $nombreproduct = $DataProducto->name;
                    $precioproduct = $DataProducto->price;
                    $Descuentos = $DataProducto->descuentos;
                    $Descripcion = $DataProducto->long_description;
                    $Calculo = ($precioproduct * $Descuentos) / 100 ;
                    $PrecioSinDescuento = $precioproduct + $Calculo;
                    $NOM_FOTO_PORTP = $DataProducto->NOM_FOTO_PORTP;
                    $NOM_FOTO_PORTS = $DataProducto->NOM_FOTO_PORTS;

                    $xruta_prod_portp = "/images/productos/portadap/".$NOM_FOTO_PORTP;
                    $xruta_prod_ports = "/images/productos/portadas/".$NOM_FOTO_PORTS;
                    
                    

                    $codigofoto = $codproduct.'00';
                        ...
                        <div class="product">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="{{$xruta_prod_portp}}" alt="product_img1">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Añadir al Carrito</a></li>
                                        <li><a href="shop-compare.html" class="popup-ajax"><i class="icon-shuffle"></i></a></li>
                                        <li><a href="/productodet/{{$codproduct}}"><i class="icon-magnifier-add"></i></a></li>
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="product_info">
                                <h6 class="product_title"><a href="shop-product-detail.html">{{$nombreproduct}}</a></h6>
                                <div class="product_price">
                                    <span class="price">S/.{{$precioproduct}}</span>
                                    <del>S/.{{$PrecioSinDescuento}}</del>
                                    <div class="on_sale">
                                        <span>{{$Descuentos}}% Descuento</span>
                                    </div>
                                </div>
                                ...
                                <div class="list_product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Añadir al Carrito</a></li>
                                        <li><a href="shop-compare.html" class="popup-ajax"><i class="icon-shuffle"></i></a></li>
                                        <li><a href="/productodet/{{$codproduct}}" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="widget">
                        <div class="shop_banner">
                            <div class="banner_img overlay_bg_20">
                                <img src="/activos/pWebPage/shopwise_v1/assets/images/sidebar_banner_img.jpg" alt="sidebar_banner_img">
                            </div>
