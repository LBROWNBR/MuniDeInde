        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb justify-content-md-end">
                    ...
                    <li class="breadcrumb-item active">Ver Carrito</li>
                </ol>
            </div>
        </div>
    </div><!-- END CONTAINER-->
            ...
            <div class="col-12">
                <div class="table-responsive shop_cart_table">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td class="product-thumbnail"><a href="#"><img src="/activos/pWebPage/shopwise_v1/assets/images/product_img1.jpg" alt="product1"></a></td>
                            ...
                            <tr>
                                <td class="product-thumbnail"><a href="#"><img src="/activos/pWebPage/shopwise_v1/assets/images/product_img2.jpg" alt="product2"></a></td>
                            ...
                            <tr>
                                <td class="product-thumbnail"><a href="#"><img src="/activos/pWebPage/shopwise_v1/assets/images/product_img3.jpg" alt="product3"></a></td>
