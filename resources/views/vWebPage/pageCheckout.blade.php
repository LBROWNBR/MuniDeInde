        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="toggle_info">
                    <span><i class="fas fa-user"></i>¿Soy Cliente? <a href="#loginform" data-toggle="collapse" class="collapsed" aria-expanded="false">Haga clic aquí para ingresar</a></span>
                </div>
                <div class="panel-collapse collapse login_form" id="loginform">
                    <div class="panel-body">
                        <p>Si ya ha comprado con nosotros, ingrese sus datos a continuación. Si es un cliente nuevo, vaya a la sección Facturación y envío.</p>
                        <form method="post">
            ...
            <div class="col-lg-6">
                <div class="toggle_info">
                    <span><i class="fas fa-tag"></i>¿Tiene un cupón? <a href="#coupon" data-toggle="collapse" class="collapsed" aria-expanded="false">Haga clic aquí para ingresar su código</a></span>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="order_review">
                    ...
                    <a href="/confirmado" class="btn btn-fill-out btn-block">Realizar pedido</a>
                </div>
            </div>
        </div>
    </div>
